...
Section "MainSection" SEC01
  ...
  File "dist\lib\htmlcleaner-2.21.jar"
  File "dist\lib\jackrabbit-webdav-2.14.6.jar"
...
no_quest:
  ...
  Delete "$INSTDIR\lib\htmlcleaner-2.21.jar"
  Delete "$INSTDIR\lib\jackrabbit-webdav-2.14.6.jar"
