...
public class O365Token {
    ...
    public void setJsonToken(JSONObject jsonToken) throws IOException {
        ...
        try {
            ...
            if (Settings.isGraphEnabled() && scope != null && !scope.contains("Mail.ReadWrite")) {
                throw new DavMailAuthenticationException("LOG_MESSAGE", "Received a token without Mail.ReadWrite for a graph session");
            }
